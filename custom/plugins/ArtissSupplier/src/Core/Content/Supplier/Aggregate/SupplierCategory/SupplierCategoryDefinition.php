...
namespace Artiss\Supplier\Core\Content\Supplier\Aggregate\SupplierCategory;
...
class SupplierCategoryDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'supplier_category';
